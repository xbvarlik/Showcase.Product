...
export declare class SchemaEngine {
    private debug;
    private child?;
    private schemaPath?;
    private listeners;
    ...
    isRunning: boolean;
    constructor({ debug, schemaPath, enabledPreviewFeatures }: SchemaEngineOptions);
    /**
     ...
     */
    introspect({ schema, force, baseDirectoryPath, compositeTypeDepth, // cannot be undefined
