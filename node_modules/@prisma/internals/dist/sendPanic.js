...
async function sendPanic({
  ...
  const schema = (0, import_ts_pattern.match)(error).with({ schemaPath: import_ts_pattern.P.not(import_ts_pattern.P.nullish) }, (err) => {
    return import_fs.default.readFileSync(err.schemaPath, "utf-8");
  }).with({ schema: import_ts_pattern.P.not(import_ts_pattern.P.nullish) }, (err) => err.schema).otherwise(() => void 0);
